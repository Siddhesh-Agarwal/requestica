...
class RequestEncodingMixin(BaseModel):
    url: str
    ...
    def _encode_params(data):
        ...
        if isinstance(data, (str, bytes)):
            ...
            result = []
            k_and_vs = to_key_val_list(data) or []
            for k, vs in k_and_vs:
    ...
    def _encode_files(files, data):
        ...
        new_fields = []
        fields = to_key_val_list(data or {}) or []
        files = to_key_val_list(files or {}) or []
...
class RequestHooksMixin(BaseModel):
    ...
    def deregister_hook(self, event: Literal["response", "request"], hook: Callable):
...
class PreparedRequest(RequestEncodingMixin, RequestHooksMixin):
    ...
    url: str
    method: RequestMethods
    _cookies: Optional[RequestsCookieJar]
    ...
    def prepare_method(self, method: RequestMethods):
    ...
    @staticmethod
    def _get_idna_encoded_host(host: str | bytes | bytearray):
        import idna
    ...
    def prepare_body(self, data, files, json=None):
        ...
        if is_stream:
            ...
            if content_type and "content-type" not in self.headers.keys():
    ...
    def prepare_auth(self, auth, url: Optional[str] = ""):
