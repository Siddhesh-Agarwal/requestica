...
class HTTPAdapter(BaseAdapter):
    ...
    def build_response(self, req: PreparedRequest, resp: HTTPResponse):
        ...
        response.status_code = getattr(resp, "status", -1)
    ...
    def get_connection(self, url, proxies: Optional[Dict[str, str]] = None):
    ...
    def request_url(self, request: PreparedRequest, proxies: Dict[str, str]):
    ...
    def proxy_headers(self, proxy: str):
    ...
    def send(
        ...
        if isinstance(timeout, tuple):
            try:
                ...
                timeout = TimeoutSauce(connect=connect, read=read).read_timeout
            except ValueError:
                raise ValueError(
            ...
            timeout = TimeoutSauce(connect=timeout, read=timeout).read_timeout
